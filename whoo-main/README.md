...
![](https://img.shields.io/github/stars/s27x4/whoo.svg) ![](https://img.shields.io/github/forks/s27x4/whoo.svg) ![](https://img.shields.io/github/tag/s27x4/whoo.svg) ![](https://img.shields.io/github/release/s27x4/whoo.svg) ![](https://img.shields.io/github/issues/s27x4/whoo.svg) ![](https://img.shields.io/bower/v/whoo.svg)
...
```py
import WhooPy as whoo
with whoo.Client(token="your token") as client:
    ...  # ここに操作を書く
```
#### on_unauthorized コールバック例
```py
def refresh_token() -> str:
    return "new-token"

client = whoo.Client(token="expired", on_unauthorized=refresh_token)
```
### 認証(email/password)
```py
import WhooPy as whoo
